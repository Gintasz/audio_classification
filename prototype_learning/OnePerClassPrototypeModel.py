...
class OnePerClassPrototypeModel(nn.Module):
    def __init__(self, num_classes: int):
        ...
        self.prototype_layer = PrototypeRepresentationLayer(num_prototypes=num_classes, num_timesteps=81, num_coeffs=13 * 3)
        self.loss_function = PrototypeLoss(num_classes=num_classes)
